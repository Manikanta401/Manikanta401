...
namespace ScoolManagement_3.Controllers
{
    public class LecturersController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,FirstName,LastName,CourseTaken")] Lecturer lecturer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,FirstName,LastName,CourseTaken")] Lecturer lecturer)
        {
            if (ModelState.IsValid)
            {
